-- Marking: lua,aggregator,aggregation_cpu,1

local aggregator = {
    category = "aggregator",
    name = "aggregation_performance_v5",
    dataVersion = "1",
    indicator = "aggregation_performance_v5"
}
...
local function systemCpuField(dataTable)
    local field = {}
    local nameArray = {"cpu"}
