-- Marking: lua,aggregator,aggregation_line_tcp_resend,1

local aggregator = {
    category = "aggregator",
    name = "aggregation_line_tcp_resend_v5",
    dataVersion = "1",
    indicator = "aggregation_line_tcp_resend_v5"
}

local template = {
    category = "line_tcp_resend",
    values = {},
    interval = 60,
    slice_cnt = 1,
    slice_idx = 0,
...
local function fillTemplate()
    template.category = "line_tcp_resend"
